<template>
  <svg
    ...
    x="0px"
    y="0px"
    viewBox="0 0 184.8 232.9"
    style="enable-background: new 0 0 184.8 232.9"
    xml:space="preserve"
  >
    <style type="text/css">
      .st0 {
    ...
    <g>
      <path
        class="st0"
        d="M130.9,195.9h-3.1V180h3.1c20.9,0,38-17,38-38V98.5c0-1.9-1.5-3.4-3.4-3.4h-37.8V79.2h37.8
		c10.6,0,19.3,8.6,19.3,19.3V142C184.7,171.7,160.6,195.9,130.9,195.9z"
      />
      <path
        class="st0"
        d="M91.4,232.9H41.7c-23,0-41.6-18.6-41.6-41.6V71.1H133v120.1C133,214.2,114.4,232.9,91.4,232.9z"
      />
      <path
        class="st1"
        d="M41.7,224.9C23.1,224.9,8,209.8,8,191.2v-127h117v127c0,18.6-15.1,33.7-33.7,33.7H41.7z"
      />
      <path
        class="st2"
        d="M125,191.2v-127H66.5v160.7h24.8C110,224.9,125,209.8,125,191.2z"
      />
      <path
        class="st3"
        d="M136,51.8c0-9.2-6.9-16.8-15.9-17.8c0.9-2.1,1.3-4.4,1.3-6.8c0-9.9-8-17.9-17.9-17.9
      ...
      <path
        class="st4"
        d="M20.6,57.2c0-0.6-0.1-1.2-0.1-1.8c0-15.6,12.6-28.2,28.2-28.2c13,0,23.9,8.8,27.2,20.7
